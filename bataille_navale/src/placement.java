...
public class placement {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Nous allons commencer par le placement des bateaux. Merci de saisir la première case et la dernière case de votre 1er cuirassé (de 4 cases)");
